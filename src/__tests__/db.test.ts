...
const { mockInsert, mockUpdate, mockDelete, mockFrom, mockGetUser, mockUpsert } = vi.hoisted(() => {
  ...
  return { mockInsert, mockUpdate, mockDelete, mockFrom, mockGetUser, mockUpsert };
});
