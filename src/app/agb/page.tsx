...
export const metadata: Metadata = {
  title: "AGB | TeamRadar",
  description: "Allgemeine Geschäftsbedingungen der TeamRadar der WAMOCON GmbH.",
};
  ...
  return (
    <LegalPageShell title="Allgemeine Geschäftsbedingungen" updatedAt="März 2026">
      <LegalSection title="§ 1 Geltungsbereich">
        ...
        <p>(2) Die Plattform richtet sich an Unternehmen, Beratungsagenturen, Entwicklerteams und sonstige gewerbliche Einheiten (nachfolgend „Auftraggeber“) sowie deren Benutzer (nachfolgend „Nutzer“). Es handelt sich um ein B2B-Angebot. Verbraucher im Sinne des § 13 BGB sind nicht Zielgruppe dieses Angebots.</p>
      ...
      <LegalSection title="§ 3 Leistungsbeschreibung">
        <p>(1) Der Anbieter stellt dem Auftraggeber die Plattform TeamRadar als Software-as-a-Service (SaaS) über das Internet zur Verfügung. Die Plattform ist eine digitale Lösung für Personalverfügbarkeitsmanagement, Projektplanung und Auslastungssteuerung.</p>
      ...
      <LegalSection title="§ 4 Nutzungsrechte">
        ...
        <p>(2) Das Nutzungsrecht umfasst den Zugriff auf die Plattform über einen Webbrowser. Ein Recht auf Überlassung des Quellcodes besteht nicht.</p>
      ...
      <LegalSection title="§ 7 Gewährleistung und Mängelbeseitigung">
        ...
        <p>(2) Mängel hat der Auftraggeber unverzüglich nach Entdeckung unter möglichst genauer Beschreibung schriftlich oder per E-Mail an <a className="font-medium text-blue-600 hover:underline" href="mailto:info@wamocon.com">info@wamocon.com</a> zu melden.</p>
