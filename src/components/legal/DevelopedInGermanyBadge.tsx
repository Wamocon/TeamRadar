  ...
  return (
    <div className="flex flex-col items-center gap-3 py-6 opacity-40 hover:opacity-100 transition-opacity">
      <div className="relative group">
        ...
        >
          {/* Outer Circles */}
          <circle cx="100" cy="100" r="96" stroke="currentColor" strokeWidth="4" className="text-gray-300 dark:text-white/10 opacity-20" />
          <circle cx="100" cy="100" r="86" stroke="currentColor" strokeWidth="2" className="text-gray-300 dark:text-white/10 opacity-10" />
      ...
      <span className="text-[14px] font-medium tracking-wide text-gray-500 dark:text-white/40">
