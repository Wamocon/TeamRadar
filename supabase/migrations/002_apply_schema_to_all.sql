-- Migration für alle Schemas (public, test, prod)
-- Führt die Tabellenanlage und Policies für das jeweils aktive Schema aus
...
-- Hinweis: In Supabase SQL Editor ggf. einzeln ausführen, da \i nicht unterstützt wird.
-- Alternativ: Skript-Inhalt für jedes Schema kopieren und search_path setzen.